...
jQuery('.upload_badge_button').on('click', function( event ){
  ...
  $('#create_course_action').click(function(event){
        ...
        $.confirm({
          text: wplms_front_end_messages.create_course_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.create_course_confrim_button,
  ...
  $('body').delegate('#save_course_settings','click',function(event){
    ...
    $('body').delegate('.new_unit_actions .publish','click',function(event){
        ...
        $.confirm({
          text: wplms_front_end_messages.create_unit_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.create_unit_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
    });
    ...
    $('body').delegate('.new_quiz_actions .publish','click',function(event){
        ...
        $.confirm({
          text: wplms_front_end_messages.create_quiz_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.create_quiz_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
    });
    ...
    $('body').delegate('.new_q .publish','click',function(event){
        ...
        $.confirm({
          text: wplms_front_end_messages.create_question_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.create_question_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
    });
    ...
    $('body').delegate('.curriculum .dropdown-menu .delete','click',function(event){
        ...
        var id = $(this).closest('h3.title').attr('data-id');
    ...
    $('body').delegate('#save_pricing ','click',function(event){
        ...
        var course_pricing={};
            ...
            if($('#vibe_product').length){
                ...
                course_pricing['vibe_duration']=$('#vibe_duration').val();
            }
...
*/
  ...
  $('body').delegate('#save_unit_settings','click',function(event){
       ...
       if($('#vibe_forum').length)
        ...
        $this.addClass('disabled');
        $.confirm({
          text: wplms_front_end_messages.save_unit_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.save_unit_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
  });
  ...
  $('body').delegate('.save_quiz_settings','click',function(event){
        ...
        $.confirm({
          text: wplms_front_end_messages.save_quiz_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.save_quiz_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
  ...
  $('#vibe_question_type').change(function(event){
    ...
    $('#save_question_settings').click(function(event){
        ...
        $.confirm({
          ...
          confirmButton: wplms_front_end_messages.save_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
    });
  ...
  $('body').delegate('.new_assignment_actions .publish','click',function(event){
        ...
        $.confirm({
          text: wplms_front_end_messages.create_assignment_confrim,
          confirm: function() {
             $.ajax({
                    type: "POST",
                    url: ajaxurl,
          ...
          confirmButton: wplms_front_end_messages.create_assignment_confrim_button,
          cancelButton: vibe_course_module_strings.cancel
          });
    });
